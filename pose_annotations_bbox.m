...
function pose_annotations_bbox(draw)
...
for seq_id = 68:91
    ...
    for k = 1:num_frames
        ...
        for j = 1:num
            ...
            bbox = [x1 y1 x2 y2];
            object.bboxes(:,:,ind) = bbox;

            output_filename = fullfile(opt.root, 'data', sprintf('%04d/%06d-bbox-meta.mat', seq_id, k));
